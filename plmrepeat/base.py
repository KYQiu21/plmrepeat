...
class AllRepeatDector(RepeatDetector):
    ...
    def __init__(self,
        ...
        super().__init__(emb, seq, win_len, min_span, ssa_sigma_factor, ssa_score_threshold, transitive_score_threshold, scan_score_threshold, scan_sigma_factor, scan_with_weighted,
                         repeat_length_threshold, repeat_score_threshold, repeat_avg_length_threshold, overlap_threshold, use_transitivity, mask_matrix, weight_repeat_emb, globalmode, draw_during_procedure)
        self.emb = emb
        self.seq = seq
