...
def create_arg_parser():
    ...
    parser.add_argument('--overlap-threshold', default=0.3, type=float, help='maximum overlap threshold of detected traces to accept')
...
def main():
    ...
    for repeat_idx, repeat_result in result.items():
        ...
        save_result(select_result_info_dict, repeat_idx, draw=draw, save_path=save_path, repeat_idx=repeat_idx)
